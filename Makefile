...
link:
	...
	$(call create_link,$(PKG_DIR)/yazi,$(HOME)/.config/yazi)
	$(call create_link,$(PKG_DIR)/zellij,$(HOME)/.config/zellij)
...
unlink:
	...
	$(call remove_link,$(PKG_DIR)/yazi,$(HOME)/.config/yazi)
	$(call remove_link,$(PKG_DIR)/zellij,$(HOME)/.config/zellij)
